//===----------------------------------------------------------------------===//
//
// This file declares LAIN-specific per-machine-function information.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_LAIN_LAINMACHINEFUNCTIONINFO_H
#define LLVM_LIB_TARGET_LAIN_LAINMACHINEFUNCTIONINFO_H
...
public:
  LAINFunctionInfo() {}
  explicit LAINFunctionInfo(MachineFunction &MF) {}
  ~LAINFunctionInfo() {}
...
#endif // LLVM_LIB_TARGET_LAIN_LAINMACHINEFUNCTIONINFO_H
